...
**Backbone:** `swin.tiny.patch4_window7_224` (pretrained on ImageNet-1k)

## 1. Overview

This repository implements an end-to-end MLOps pipeline for fine-tuning **Swin-Tiny**
...
├──acv_assignment_1.py        # full pipeline (python-ready)
...
Open `notebooks/swin_ablation.ipynb` and run cells sequentially.
...
| `docs/architecture_diagram.png` | Baseline vs. ablation schematic with modified blocks highlighted |
